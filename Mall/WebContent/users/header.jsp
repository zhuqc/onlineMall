				...
				<div class="header_r">
					...
					<c:if test="${sessionScope.userid != null }">
						<font id="ECS_MEMBERZONE"> 欢迎光临本站${sessionScope.username }，
						 <a href="index/cart.action">[购物车]</a>&nbsp;
						 <a href="index/usercenter.action">[用户中心]</a>&nbsp;
						 <a href="index/exit.action">[退出系统]</a> </font>
					</c:if>
				</div>
			</div>
		</div>
...
<div class="menu_box clearfix">
	<div class="block">
		<div class="menu">
			...
			<a href="index/special.action" class="cur">特价商品</a>
			<a href="index/recommend.action" class="cur">推荐商品</a>
			<a href="index/all.action" class="cur">全部商品</a>
		</div>
	</div>
</div>