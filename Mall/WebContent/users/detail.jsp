					...
					<form action="index/addcart.action" method="post"
						...
						<ul class="ul2 clearfix">
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>本店售价：</strong><font class="shop" id="ECS_SHOPPRICE">￥${goods.price }元</font>
							...
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>商品类型：</strong><a
										href="index/cate.action?id=${goods.cateid }">${goods.catename }</a>
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>商品重量：</strong>${goods.weights }
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
									<strong>库存：</strong>${goods.storage }
								</dd>
							</li>
							<li class="clearfix" style="width: 100%">
								<dd>
						...
						<ul class="bnt_ul">
							...
							<li class="padd"><input type="image"
								src="themes/xecmoban_shunfeng/images/goumai2.png" /></li>
						</ul>
					</form>
				</div>
			</div>
